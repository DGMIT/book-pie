  ...
  implements ReportRepositoryInterface
{
  ...
  public async getReportList<T>(
    request: RequestGetReportList,
    connection?: any
  ): Promise<T[]> {
    const queryInfo: QueryInfo = ReportQuery(
      ReportQueryId.getReportList,
      request
    );
  ...
  public async createReport<T>(
    request: RequestCreateReport,
    connection?: any
  ): Promise<T> {
    const queryInfo: QueryInfo = ReportQuery(
      ReportQueryId.createReport,
      request
    );
  ...
  public async updateReport<T>(
    request: RequestUpdateReport,
    connection?: any
  ): Promise<T> {
    const queryInfo: QueryInfo = ReportQuery(
      ReportQueryId.updateReport,
      request
    );
    return await this.execute(
      queryInfo.queryStr,
  ...
  public async getConsecutiveDays<T>(connection?: any): Promise<T[]> {
    const queryInfo: QueryInfo = ReportQuery(ReportQueryId.getConsecutiveDays);
    return await this.query(
      queryInfo.queryStr,
      queryInfo.queryParams,
      connection
